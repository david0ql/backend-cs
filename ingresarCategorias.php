                  ...
                  <div class="row">
                     <div class="col-md-12 col-lg-12 col-12">
                        <div class="card card-primary">
                           ...
                           <form method="POST" action="validaciones/crearCategoria.php">
                              <div class="card-body">
                                 <div class="form-group">
                                    <label for="">Titulo</label>
                                    <input type="text" class="form-control" name="categoria" placeholder="Ingrese la categoria" required autocomplete="off">
                                 </div>
                              </div>
